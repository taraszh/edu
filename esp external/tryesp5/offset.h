...
namespace offsets
{
	...
	constexpr ptrdiff_t dwEntityList = 0x4D43AD4;
	constexpr ptrdiff_t dwForceAttack = 0x3175084;
	constexpr ptrdiff_t dwForceAttack2 = 0x3175090;
	constexpr ptrdiff_t dwForceBackward = 0x31750D8;
	constexpr ptrdiff_t dwForceForward = 0x31750E4;
	constexpr ptrdiff_t dwForceJump = 0x51ED770;
	constexpr ptrdiff_t dwForceLeft = 0x31750FC;
	constexpr ptrdiff_t dwForceRight = 0x31750F0;
	constexpr ptrdiff_t dwGameDir = 0x6285F8;
	constexpr ptrdiff_t dwGameRulesProxy = 0x5260A4C;
	constexpr ptrdiff_t dwGetAllClasses = 0xD55F2C;
	constexpr ptrdiff_t dwGlobalVars = 0x589AD0;
	constexpr ptrdiff_t dwGlowObjectManager = 0x528B8C8;
	constexpr ptrdiff_t dwInput = 0x5195080;
	constexpr ptrdiff_t dwInterfaceLinkList = 0x8F9DE4;
	constexpr ptrdiff_t dwLocalPlayer = 0xD2FB94;
	constexpr ptrdiff_t dwMouseEnable = 0xD35738;
	constexpr ptrdiff_t dwMouseEnablePtr = 0xD35708;
	constexpr ptrdiff_t dwPlayerResource = 0x317341C;
	constexpr ptrdiff_t dwRadarBase = 0x5178844;
	constexpr ptrdiff_t dwSensitivity = 0xD355D4;
	constexpr ptrdiff_t dwSensitivityPtr = 0xD355A8;
	constexpr ptrdiff_t dwSetClanTag = 0x89E00;
	constexpr ptrdiff_t dwViewMatrix = 0x4D35414;
	constexpr ptrdiff_t dwWeaponTable = 0x5195B44;
	constexpr ptrdiff_t dwWeaponTableIndex = 0x325C;
	constexpr ptrdiff_t dwYawPtr = 0xD35398;
	constexpr ptrdiff_t dwZoomSensitivityRatioPtr = 0xD3A5E0;
	constexpr ptrdiff_t dwbSendPackets = 0xD3D5A;
	constexpr ptrdiff_t dwppDirect3DDevice9 = 0xA7030;
	constexpr ptrdiff_t m_pStudioHdr = 0x294C;
	constexpr ptrdiff_t m_yawClassPtr = 0xD35398;
	constexpr ptrdiff_t m_pitchClassPtr = 0x5178AE8;
	...
	constexpr ptrdiff_t set_abs_angles = 0x1CF0E0;
	constexpr ptrdiff_t set_abs_origin = 0x1CEF20;
	constexpr ptrdiff_t is_c4_owner = 0x3A5890;
	constexpr ptrdiff_t force_update_spectator_glow = 0x3990D2;
	constexpr ptrdiff_t anim_overlays = 0x2980;
	constexpr ptrdiff_t m_flSpawnTime = 0xA360;
	constexpr ptrdiff_t find_hud_element = 0x2C96C240;
